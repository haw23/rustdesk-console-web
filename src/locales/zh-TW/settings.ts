export default {
  ...
  'app.settings.security.question-description':
    '未設定密保問題，密保問題可有效保護帳戶安全',
  'app.settings.security.email': '備用信箱',
  'app.settings.security.email-description': '已綁定信箱',
  ...
  'app.settings.notification.password-description':
    '其他使用者的訊息將以站內信的形式通知',
  'app.settings.notification.messages': '系統訊息',
